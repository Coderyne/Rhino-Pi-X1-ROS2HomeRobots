...
void Mahony_update(struct MAHONY_FILTER_t *mahony_filter,float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
{
	float recipNorm;
...
void Mahony_computeAngles(struct MAHONY_FILTER_t *mahony_filter)
{
	...
	mahony_filter->roll = roll_mahony;
	mahony_filter->pitch = pitch_mahony;
	mahony_filter->yaw = yaw_mahony;
}
