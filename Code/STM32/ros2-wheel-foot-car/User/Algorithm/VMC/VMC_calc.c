...
{		
	  ...
	  PitchR=BODY_PITCH_SIGN*ins->Pitch;
	  PithGyroR=BODY_PITCH_GYRO_SIGN*ins->Gyro[1];
...
{		
	  ...
	  PitchL=-BODY_PITCH_SIGN*ins->Pitch;
	  PithGyroL=-BODY_PITCH_GYRO_SIGN*ins->Gyro[1];
