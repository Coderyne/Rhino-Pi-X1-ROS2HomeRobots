...
{ 
  if((RxFifo0ITs & FDCAN_IT_RX_FIFO0_NEW_MESSAGE) != RESET)
  {
    if(hfdcan->Instance == FDCAN1)
    {
      ...
      // char id_str[32];
      // sprintf(id_str, "Received CAN ID: %u\r\n", RxHeader1.Identifier);
      // UART_PrintString(&huart10, id_str);  
			GIM6010_fbdata(RxHeader1.Identifier, g_Can1RxData);			
	  }
  }
}
  ...
  if((RxFifo1ITs & FDCAN_IT_RX_FIFO1_NEW_MESSAGE) != RESET)
  {
    if(hfdcan->Instance == FDCAN2)
    {
      ...
      HAL_FDCAN_GetRxMessage(hfdcan, FDCAN_RX_FIFO1, &RxHeader2, g_Can2RxData);
			...
			{ 	         	
				//case 5 :dm6215_fbdata(&chassis_move.wheel_motor[0], g_Can1RxData,RxHeader1.DataLength);break; 
        case 0x15:     	
				  dm6215_fbdata(g_Can2RxData,RxHeader2.DataLength);break;
        case 0x16:     	
				  dm6215_fbdata(g_Can2RxData,RxHeader2.DataLength);break;
          default:break;
