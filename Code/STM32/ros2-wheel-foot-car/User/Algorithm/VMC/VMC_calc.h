...
#define LEG_PID_KD  8000.0f
#define LEG_PID_MAX_OUT  180.0f //180牛
#define LEG_PID_MAX_IOUT 0.0f

// 控制层的pitch轴符号校正：用于统一VMC、底盘反馈与观测器方向
#define BODY_PITCH_SIGN (-1.0f)
#define BODY_PITCH_GYRO_SIGN (-1.0f)
